...
| 平台SDK | 状态 | 渲染技术 | UI框架 |
|---|---|---|---|
| Android（Fork 修改版，[仓库](./platform/Android)） | ✅ 已实现 | Canvas + Paint | Android View |
| iOS（Fork 修改版，[仓库](./platform/Apple)） | ✅ 已实现 | CoreText + CoreGraphics | UIKit（已封装） / SwiftUI（正在完善） |
| macOS（Fork 修改版，[仓库](./platform/Apple)） | ✅ 已实现 | CoreText + CoreGraphics | AppKit（已封装） / SwiftUI（正在完善） |
| Windows（Fork 修改版，[仓库](./platform/WinForms)） | ✅ 已实现 | GDI+ | WinForms |
| Swing（Fork 修改版，[仓库](./platform/Swing)） | ✅ 已实现 | Java2D | Swing |
| OHOS（Fork 修改版，[仓库](./platform/OHOS)） | ✅ 已实现 | ArkUI Canvas | ArkUI |
| Web（Fork 修改版，[仓库](./platform/Emscripten)） | 🚧 测试中 | Canvas | - |
| Flutter | 🚧 进行中 | - | Flutter |
