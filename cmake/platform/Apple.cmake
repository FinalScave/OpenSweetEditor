function(sweeteditor_platform_configure)
    if (CMAKE_SYSTEM_NAME STREQUAL "iOS")
        ...
        set(SWEETEDITOR_PLATFORM_ID "osx" PARENT_SCOPE)
        set(SWEETEDITOR_PLATFORM_COMPILE_DEFINITIONS OSX PARENT_SCOPE)
    endif ()
endfunction()
...
function(sweeteditor_platform_add_extra_targets)
    ...
    set(_sweeteditor_framework_name "SweetEditorCore")
    set(_sweeteditor_framework_identifier "com.qiplat.sweeteditor.core")
