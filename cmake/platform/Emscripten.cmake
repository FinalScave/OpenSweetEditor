function(sweeteditor_platform_configure)
    set(SWEETEDITOR_PLATFORM_ID "emscripten" PARENT_SCOPE)
    set(SWEETEDITOR_PLATFORM_COMPILE_DEFINITIONS WASM PARENT_SCOPE)
endfunction()

function(sweeteditor_platform_validate_build_options)
    if (NOT SWEETEDITOR_BUILD_STATIC
            AND NOT SWEETEDITOR_BUILD_TESTS
            AND NOT SWEETEDITOR_BUILD_WASM_C_ABI
            AND NOT SWEETEDITOR_BUILD_WASM_EMBIND)
...
function(sweeteditor_platform_add_extra_targets)
    ...
    if (SWEETEDITOR_BUILD_WASM_C_ABI)
        ...
        add_library(${WASM_C_API_OBJECT_TARGET} OBJECT ${SWEETEDITOR_C_API_SOURCE_FILES})
