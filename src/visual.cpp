...
#pragma region[Class: VisualLine]
  U8String VisualLine::dump() const {
    U8String result = "VisualLine {logical_line = " + std::to_string(logical_line) + ", wrap_index = "
                      + std::to_string(wrap_index) + ", kind = " + std::to_string(static_cast<int>(kind))
                      + ", owns_gutter_semantics = " + std::to_string(owns_gutter_semantics) + ", runs = [";
...
#pragma endregion
  ...
  U8String dumpEnum(GuideDirection direction) {
    switch (direction) {
    case GuideDirection::VERTICAL:
      return "VERTICAL";
    case GuideDirection::HORIZONTAL:
      return "HORIZONTAL";
    default:
      return "UNDEFINED";
    }
  ...
  U8String dumpEnum(GuideType type) {
    switch (type) {
    case GuideType::INDENT:
      return "INDENT";
    case GuideType::BRACKET:
      return "BRACKET";
    case GuideType::FLOW:
      return "FLOW";
    case GuideType::SEPARATOR:
      return "SEPARATOR";
    default:
      return "UNDEFINED";
    }
  ...
  U8String dumpEnum(GuideStyle style) {
    switch (style) {
    case GuideStyle::SOLID:
      return "SOLID";
    case GuideStyle::DASHED:
      return "DASHED";
    case GuideStyle::DOUBLE:
      return "DOUBLE";
    default:
      return "UNDEFINED";
    }
