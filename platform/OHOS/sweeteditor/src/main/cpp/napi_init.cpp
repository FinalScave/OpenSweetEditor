...
static napi_value Init(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        ...
        NAPI_METHOD("editorImeSetComposingText", EditorCoreNapi::imeSetComposingText),
        NAPI_METHOD("editorImeSetComposingTextSelection", EditorCoreNapi::imeSetComposingTextSelection),
        ...
        NAPI_METHOD("editorImeMarkDocumentRangeByOffset", EditorCoreNapi::imeMarkDocumentRangeByOffset),
        NAPI_METHOD("editorImeReplaceText", EditorCoreNapi::imeReplaceText),
        NAPI_METHOD("editorImeReplaceDocumentText", EditorCoreNapi::imeReplaceDocumentText),
        NAPI_METHOD("editorImeReplaceInputContextText", EditorCoreNapi::imeReplaceInputContextText),
        ...
        NAPI_METHOD("editorGetImeInputContext", EditorCoreNapi::getImeInputContext),
