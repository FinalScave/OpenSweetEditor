...
struct EditorTheme {
    ...
    static func dark() -> EditorTheme {
        EditorTheme(
            ...
            invisibleCharacterColor:  CGColor(srgbRed: 0x6B/255.0, green: 0x78/255.0, blue: 0x90/255.0, alpha: 0x48/255.0),
            syntaxStyles: [
    ...
    static func light() -> EditorTheme {
        EditorTheme(
            ...
            invisibleCharacterColor:  CGColor(srgbRed: 0x5D/255.0, green: 0x6B/255.0, blue: 0x82/255.0, alpha: 0x40/255.0),
            syntaxStyles: [
