...
final class SweetLineDecorationProvider: DecorationProvider {
    ...
    private static let engineResult = Result<HighlightEngine, Error> {
        ...
        let syntaxURLs = Bundle.main.urls(
            forResourcesWithExtension: "json",
            subdirectory: "syntaxes"
    ...
    static func makeTheme(isDark: Bool) -> EditorTheme {
